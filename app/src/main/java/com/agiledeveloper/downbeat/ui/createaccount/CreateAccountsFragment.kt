package com.agiledeveloper.downbeat.ui.createaccount
...
class CreateAccountsFragment : Fragment() {
    ...
    private lateinit var galleryViewModel: CreateAccountsViewModel
    ...
    override fun onCreateView(
        ...
        val backbutton2 = root.findViewById<ImageView>(R.id.backbutton2)
        //Handle button taps
